...
developmentChains.includes(network.name)
    ...
    : describe("HelloDefiAAVE2 contract staging test", async () => {
          ...
          before(async () => {
              ...
              helloDefiAAVE2Factory = await ethers.getContract(
          ...
          describe("simple scenario", async () => {
              ...
              beforeEach(async () => {
                  ...
                  helloDefiAAVE2 = await ethers.getContractAt(
                      "HelloDefiAAVE2",
                      existingCloneAddress
                  );
                  value = await helloDefiAAVE2.depositedBalance(
                      daiContractAddress
                  );
                  await daiContract
                      .connect(deployer)
              ...
              it("withdraw should transfer the smart contract total amount balance - the performance fees to the user", async () => {
                  ...
                  expect(
                      await helloDefiAAVE2.depositedBalance(daiContractAddress)
